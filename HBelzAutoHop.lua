...
local HopKata2 = Tabs.Main:AddToggle("DKHop", {
...
local HopRip = Tabs.Main:AddToggle("RipHop", {
...
local HopDark = Tabs.Main:AddToggle("HopDark", {
	Title = "Auto Hop Dark Beard",
	Default = false
})
...
local HopSoul = Tabs.Main:AddToggle("HopSoul", {
...
local HopCursed = Tabs.Main:AddToggle("HopCursed", {
	Title = "Auto Hop Cursed Captain",
	Default = false
})
...
local HopOroshi = Tabs.Main:AddToggle("HopOroshi", {
	Title = "Auto Hop Oroshi Sword",
	Default = false
})
	...
	while task.wait(5) do
		pcall(function()
			if _G.HopOroshi then
				local OroshiSpawned = game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("LegendarySwordDealer", "2")
...
local HopShizu = Tabs.Main:AddToggle("HopShizu", {
	Title = "Auto Hop Shizu Sword",
	Default = false
})
...
spawn(function()
	while task.wait(5) do
		pcall(function()
			if _G.HopShizu then
				local ShizuSpawned = game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("LegendarySwordDealer", "1")
...
local HopSaishi = Tabs.Main:AddToggle("HopSaishi", {
	Title = "Auto Hop Saishi Sword",
	Default = false
})
	...
	while task.wait(5) do
		pcall(function()
			if _G.HopSaishi then
				local SaishiSpawned = game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("LegendarySwordDealer", "3")
...
ImageLabel.Image = "rbxassetid://13482359782206"
