...
_G.Color = Color3.fromRGB(32, 228, 208);
...
v3.Window = function(v209, v210, v211, v212)
	...
	v243.Name = "Logo";
	v243.Parent = v235;
	v243.BackgroundColor3 = Color3.fromRGB(32, 228, 208);
	...
	v251.Name = "Name";
	v251.Parent = v235;
	v251.BackgroundColor3 = Color3.fromRGB(32, 228, 208);
	...
	v251.Text = v210;
	v251.TextColor3 = Color3.fromRGB(32, 228, 208);
	v251.TextSize = 16;
	local v263 = Instance.new("TextLabel");
	v263.Name = "";
	v263.Parent = v235;
	v263.BackgroundColor3 = Color3.fromRGB(32, 228, 208);
	...
	v274.Parent = v224;
	v274.BackgroundColor3 = Color3.fromRGB(32, 228, 208);
	...
	v294.Parent = v282;
	v294.Active = true;
	v294.BackgroundColor3 = Color3.fromRGB(32, 228, 208);
	...
	v322.BackgroundColor3 = Color3.fromRGB(32, 228, 208);
	...
	v346.T = function(v718, v719, v720)
		...
		v721.Text = v719;
		v721.BackgroundColor3 = Color3.fromRGB(32, 228, 208);
		...
		v752.Parent = v329;
		v752.Active = true;
		v752.BackgroundColor3 = Color3.fromRGB(32, 228, 208);
		...
		v772.Toggle = function(v1135, v1136, v1137, v1138)
			...
			v1142.Color = Color3.fromRGB(32, 228, 208);
			...
			v1145.ImageColor3 = Color3.fromRGB(32, 228, 208);
			v1146.Name = "Space";
			v1146.Parent = v1141;
			...
			v1147.TextColor3 = Color3.fromRGB(32, 228, 208);
			v1147.TextSize = 12;
			v1147.TextXAlignment = Enum.TextXAlignment.Left;
			v1148.Name = "ImageButton";
			v1148.Parent = v1141;
			v1148.BackgroundColor3 = Color3.fromRGB(32, 228, 208);
			...
			v1148.ImageColor3 = Color3.fromRGB(32, 228, 208);
			...
			v1148.MouseButton1Click:Connect(function()
				if (v1139 == false) then
					...
					game.TweenService:Create(v1148, TweenInfo.new(0.08, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {
						ImageColor3 = Color3.fromRGB(32, 228, 208)
					}):Play();
					v1148.ImageRectOffset = Vector2.new(940, 784);
				end
				v1139 = not v1139;
		...
		v772.Dropdown = function(v1220, v1221, v1222, v1223)
			...
			v1227.Parent = v1225;
			v1227.BackgroundColor3 = Color3.fromRGB(32, 228, 208);
			...
			v1228.Parent = v1227;
			v1228.Active = true;
			v1228.BackgroundColor3 = Color3.fromRGB(32, 228, 208);
			...
			v1232.Parent = v1225;
			v1232.BackgroundColor3 = Color3.fromRGB(32, 228, 208);
			...
			v1231.Parent = v1225;
			v1231.BackgroundColor3 = Color3.fromRGB(32, 228, 208);
			...
			for v1844, v1845 in next, v1222 do
				...
				v1846.Name = "Item";
				v1846.Parent = v1228;
				v1846.BackgroundColor3 = Color3.fromRGB(32, 228, 208);
			...
			v1298.Add = function(v1858, v1859)
				...
				v1860.Name = "Item";
				v1860.Parent = v1228;
				v1860.BackgroundColor3 = Color3.fromRGB(32, 228, 208);
		...
		v772.Slider1 = function(v1301, v1302, v1303, v1304, v1305, v1306)
			...
			v1310.Color = Color3.fromRGB(32, 228, 208);
			...
			v1312.ImageColor3 = Color3.fromRGB(32, 228, 208);
			v1313.Name = "Space";
			v1313.Parent = v1309;
			...
			v1313.Text = "";
			v1313.TextSize = 15;
			v1313.TextColor3 = Color3.fromRGB(32, 228, 208);
			...
			v1314.TextColor3 = Color3.fromRGB(32, 228, 208);
			v1314.TextSize = 12;
			v1314.TextXAlignment = Enum.TextXAlignment.Left;
			v1315.Name = "SliderInput";
			v1315.Parent = v1309;
			v1315.BackgroundColor3 = Color3.fromRGB(32, 228, 208);
			...
			v1317.Parent = v1316;
			v1317.BackgroundColor3 = Color3.fromRGB(32, 228, 208);
			...
			v1323.BackgroundColor3 = Color3.fromRGB(32, 228, 208);
			...
			v1323.TextColor3 = Color3.fromRGB(32, 228, 208);
			v1323.TextSize = 8;
			...
			v1322.Color = Color3.fromRGB(32, 228, 208);
			...
			v1321.TextColor3 = Color3.fromRGB(32, 228, 208);
			v1321.TextSize = 9;
		...
		v772.Slider = function(v1462, v1463, v1464, v1465, v1466, v1467)
			...
			v1472.Parent = v1470;
			v1472.BackgroundColor3 = Color3.fromRGB(32, 228, 208);
			...
			v1472.Text = v1463;
			v1472.TextColor3 = Color3.fromRGB(32, 228, 208);
			v1472.TextSize = 12;
			v1472.TextTransparency = 0;
			v1472.TextXAlignment = Enum.TextXAlignment.Left;
			v1473.Name = "HAHA";
			v1473.Parent = v1470;
			v1473.BackgroundColor3 = Color3.fromRGB(32, 228, 208);
			v1473.BackgroundTransparency = 1;
			v1473.Size = UDim2.new(0, 290, 0, 29);
			v1474.Name = "AHEHE";
			v1474.Parent = v1470;
			v1474.BackgroundColor3 = Color3.fromRGB(32, 228, 208);
			...
			v1479.Parent = v1476;
			v1479.BackgroundColor3 = Color3.fromRGB(32, 228, 208);
			...
			v1483.TextColor3 = Color3.fromRGB(32, 228, 208);
			v1483.TextSize = 9;
			v1483.Text = v1466;
			...
			v1485.Color = Color3.fromRGB(32, 228, 208);
		...
		v772.Textbox = function(v1588, v1589, v1590, v1591)
			...
			v1596.Parent = v1592;
			v1596.BackgroundColor3 = Color3.fromRGB(32, 228, 208);
			...
			v1597.Name = "txtbtn";
			v1597.Parent = v1592;
			v1597.BackgroundColor3 = Color3.fromRGB(32, 228, 208);
		...
		v772.Label = function(v1654, v1655)
			...
			v1656.Name = "Label";
			v1656.Parent = v752;
			v1656.BackgroundColor3 = Color3.fromRGB(32, 228, 208);
		...
		v772.Label1 = function(v1675, v1676)
			...
			v1677.Name = "Label1";
			v1677.Parent = v752;
			v1677.BackgroundColor3 = Color3.fromRGB(32, 228, 208);
		...
		v772.Seperator = function(v1696, v1697)
			...
			v1698.Parent = v752;
			v1698.BackgroundColor3 = Color3.fromRGB(32, 228, 208);
			...
			v1700.Name = "Sep2";
			v1700.Parent = v1698;
			v1700.BackgroundColor3 = Color3.fromRGB(32, 228, 208);
			...
			v1700.Text = v1697;
			v1700.TextColor3 = Color3.fromRGB(32, 228, 208);
			v1700.TextSize = 14;
			v1701.Name = "Sep3";
			v1701.Parent = v1698;
		...
		v772.Line = function(v1730)
			...
			v1731.Name = "Linee";
			v1731.Parent = v752;
			v1731.BackgroundColor3 = Color3.fromRGB(32, 228, 208);
...
game:GetService("StarterGui"):SetCore("SendNotification", {
	Title = "HBelz Hub-Blox Fruits [ Free ]",
	Text = "Loading Done!",
	Icon = "",
	Duration = 10
});
