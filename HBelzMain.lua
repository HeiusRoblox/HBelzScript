--- fix farm, fix bringmob,..
--- script by HieuYeager
...
Window = Fluent:CreateWindow({
    Title = "Heius Roblox-Blox Fruit [ Free ]",
    SubTitle = "by HieuBeoo",
    TabWidth = 155,
...
LGa:AddButton({
    ...
    Description = "but you will die for Fix Button",
    Callback = function()
    pcall(function()
        ...
        for _, v in pairs(game:GetService("Players").LocalPlayer.PlayerGui:GetDescendants()) do
            if v:IsA("Frame") and v.Name == "Main" then
                v.Position = UDim2.new(0.7, 0, 0.2, 0) -- Có thể chỉnh vị trí tùy theo hub
            end
        end
    end
});
...
Main:AddButton({
    Title = "Copy facebook invite link",
    Description = "Cày Thuê Liên Hệ",
    Callback = function()
        pcall(function()
...
ImageLabel.Name = "HBelz Hub [ Free ]"
...
ImageLabel.Image = "rbxassetid://110365071974573"
