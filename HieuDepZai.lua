...
SelectWeapon:OnChanged(function(v)
	_G.SelectWeapon = v
end)    
task.spawn(function()
        while wait() do
...
_G.AutoFarm = value
    ...
    if value then
        task.spawn(function()
            while wait() do
                if SelectFarm.Value == "Farm Level" then
                    AutoFarmLevel()
                elseif SelectFarm.Value == "Farm Near Mobs" then
                    AutoFarmNearMobs()
                elseif SelectFarm.Value == "Farm Katakuri" then
                    AutoFarmKatakuri()
                elseif SelectFarm.Value == "Farm Bone" then
                    AutoFarmBone()
                end
            end
        end)
