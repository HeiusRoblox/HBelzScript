...
local Window = Fluent:CreateWindow({
    Title="Heius Roblox-Blox Fruits [ Free ]",
    SubTitle="by HieuDZzz", 
    TabWidth=160, 
    Theme="R2LX",
    Acrylic=false,
...
AutoClick() -- Gọi hàm khi script được thực thi
...
local Teleport = Tabs.Player:AddSection("Thế Giới")
local ToggleAutoSea2 = Tabs.Player:AddToggle("ToggleAutoSea2", {
...
local ToggleAutoSea3 = Tabs.Player:AddToggle("ToggleAutoSea3", {
...
local Mastery = Tabs.Player:AddSection("Đảo")
if Sea1 then
 IslandList={
                "WindMill",
                "Marine",
...
local ToggleBuy = Tabs.Fruit:AddToggle("ToggleBuy", {Title="Mua Chip", Description="",Default=false })
...
spawn(function()
    ...
    local ToggleStart = Tabs.Fruit:AddToggle("ToggleStart", {Title="Bắt Đầu Raid",Description="", Default=false })
...
local ToggleNextIsland = Tabs.Fruit:AddToggle("ToggleNextIsland", {
...
local ToggleAwake = Tabs.Fruit:AddToggle("ToggleAwake", {Title="Thức Tỉnh",Description="", Default=false })
...
local ToggleGetFruit = Tabs.Fruit:AddToggle("ToggleGetFruit", {Title="Lấy Trái Dưới 1 Triệu",Description="", Default=false })
...
local Mastery = Tabs.Fruit:AddSection("Tập Kích Law")
local ToggleLaw = Tabs.Fruit:AddToggle("ToggleLaw", {Title="Mua Chip Và Đấm Law",Description="", Default=false })
