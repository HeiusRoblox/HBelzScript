...
v0.new("<Color=Cyan>Welcome to H-Belz Hub<Color=/>"):Display();
wait(0.5);
v0.new("<Color=Yellow><Color=/>"):Display();
wait(1);
repeat
	wait();
...
v8.Image = "rbxassetid://106674226087364";
v8.Draggable = true;
...
v67:Seperator("Informantion");
v67:Label("HieuYeagerDzS1TG");
v67:Button("Copy Facebook Link", function()
