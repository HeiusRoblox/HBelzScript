...
local Tabs = {
	...
	OthersTab = Window:Tab({
		Title = "Tab Farming Others",
		Icon = "inbox",
		Desc = "Farming Section"
	}),
	ItemsTab = Window:Tab({
		Title = "Tab Farming Items",
		Icon = "box",
		Desc = "Items Section"
	}),
	SettingsTab = Window:Tab({
		Title = "Tab Settings Farm",
		Icon = "settings",
...
RaidSection = Tabs.FruitTab:Section({
	Title = "Raid",
	TextXAlignment = "Left"
});
TimeRaidParagraph = Tabs.FruitTab:Paragraph({
	Title = "Raid Time",
	Desc = "N/A"
});
IslandRaidParagraph = Tabs.FruitTab:Paragraph({
	Title = "Island",
	Desc = "N/A"
});
spawn(function()
...
ChooseChipRaidDropdown = Tabs.FruitTab:Dropdown({
	Title = "Choose Chip",
	Values = Raidslist,
...
AutoRaidToggle = Tabs.FruitTab:Toggle({
	Title = "Auto Raid",
...
AutoAwakeningToggle = Tabs.FruitTab:Toggle({
	Title = "Auto Awaken",
...
PriceDevilFruitToUnstoreSlider = Tabs.FruitTab:Slider({
	Title = "Price",
	Value = {
		Min = 1,
		Max = 10000000,
...
AutoUnstoreDevilFruitToggle = Tabs.FruitTab:Toggle({
...
TeleportTolabButton = Tabs.FruitTab:Button({
...
LawRaidSection = Tabs.FruitTab:Section({
	Title = "Law Raid",
	TextXAlignment = "Left"
});
AutoLawRaidToggle = Tabs.FruitTab:Toggle({
	Title = "Auto Law Raid",
