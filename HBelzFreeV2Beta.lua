...
local Window = Fluent:CreateWindow({
    Title = "Heius Roblox | Free Script",
    SubTitle = "Version 2",
    TabWidth = 160,
...
local Tabs = {
    ...
    Items = Window:AddTab({ Title = "Tab Items Farm", Icon = "" }),
    Player = Window:AddTab({ Title = "Tab Local Player", Icon = "" }),
    Fruit = Window:AddTab({ Title = "Tab Fruit & Raid", Icon = "" }),
    Race = Window:AddTab({ Title = "Tab Upgrade Race", Icon = "" }),
    Hop = Window:AddTab({ Title = "Tab Hop & Attack Boss[Premium]", Icon = "" }),
}
...
--- Tabs Status
local KataStatus = Tabs.Status:AddParagraph({
        ...
        while wait() do
            pcall(function()
                if (string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 88) then
                    KataStatus:SetDesc("Kill: " .. string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"), 39, 41) .. "");
                elseif (string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 87) then
                    KataStatus:SetDesc("Kill: " .. string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"), 39, 40) .. "");
                elseif (string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 86) then
                    KataStatus:SetDesc("Kill: " .. string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"), 39, 39) .. " ");
                else
                    KataStatus:SetDesc("Spawned!");
                end
            end);
        end
    end);
    ...
    task.spawn(function()
        while task.wait() do
            pcall(function()
                ...
                MoonStatus:SetDesc("Status: " .. FullMoonStatus);
            end)
        end
    end)
local MirageParagraph = Tabs.Status:AddParagraph({
        Title = "Mirage Island",
        Content = ""
    });
        task.spawn(function()
        while task.wait() do
            pcall(function()
                ...
                MirageParagraph:SetDesc("Status: " .. MirageStatus);
            end)
        end
    end)
        ...
        while wait() do
            pcall(function()
                if (game:GetService("ReplicatedStorage"):FindFirstChild("Diablo") or game:GetService("ReplicatedStorage"):FindFirstChild("Deandre") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban") or game:GetService("Workspace").Enemies:FindFirstChild("Diablo") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre") or game:GetService("Workspace").Enemies:FindFirstChild("Urban")) then
                    v529:SetDesc("Elite Boss: Spawned! | Killed:  " .. game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("EliteHunter", "Progress"));
                else
                    v529:SetDesc("Elite Boss: Not Spawn | Killed: " .. game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("EliteHunter", "Progress"));
                end
            end);
        end
    end);
--- Tabs Main
local FarmSelect = {"Farm Level", "Farm Near Mobs", "Farm Katakuri", "Farm Bone"}
local SelectFarm = Tab:AddDropdown("SelectFarmMode", {
    Title = "SelectFarmMode",
    Description = "",
    Values = FarmSelect
    Multi = false,
    Default = 1,
...
spawn(
            function()
	while wait() do
		if FarmMode == "Farm Bone" and _G.AutoFarm and HieuDz3 then
			pcall(  
                            function()
				if game:GetService("Workspace").Enemies:FindFirstChild("Reborn Skeleton") or game:GetService("Workspace").Enemies:FindFirstChild("Living Zombie") or game:GetService("Workspace").Enemies:FindFirstChild("Demonic Soul") or game:GetService("Workspace").Enemies:FindFirstChild("Posessed Mummy") then
					...
					if BypassTP then
						if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - HieuDz.Position).Magnitude > 1500 then
							BTP(HieuDz)
						elseif (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - HieuDz.Position).Magnitude < 1500 then
							topos(HieuDz)
						end
					else
						topos(HieuDz)
...
spawn(function()
	while wait() do
		if FarmMode == "Farm Katakuri" and _G.AutoFarm and HieuDz3 then
			pcall(function()
...
local SelectWeapon = Tab:AddDropdown("Select Weapon", {
    Title = "Select Weapon",
