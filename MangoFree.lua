...
function Update:Window(text,logo,keybind)
    ...
    Ping.Text = "Heius Roblox | Blox Fruits          [RightControl]"
  ...
  --  UserImage.BackgroundColor3 = Color3.fromRGB(225, 225, 225)
	...
	Logo.Image = "rbxassetid://115496240564374"
    ...
    function main:AddButton(text, callback)
        ...
        ImageButton.Image = "rbxassetid://93834040274817"
...
local S = Library:AddTab("Tab Shop","")
local T = Library:AddTab("Tab Teleport","")
local Ss = Library:AddTab("Tab Stats","")
local Main = Library:AddTab("Tab General","")
local M = Library:AddTab("Tab Items Farm","")
local RaceV4 = Library:AddTab("Tab Upgrade Race","")
local D = Library:AddTab("Tab Fruit","")
local R = Library:AddTab("Tab Raid","")
local P = Library:AddTab("Tab PVP","")
local Misc = Library:AddTab("Tab Misc","")
---- Trang Chá»§
