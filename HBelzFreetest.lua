...
elseif game.PlaceId == 7449423635 then
	...
	game:GetService("Players").LocalPlayer:Kick("Map không hỗ trợ. Vui lòng vào Sea 1, 2 hoặc 3.")
end
...
function TPP(CFgo)
	...
	local tween = tween_s:Create(game.Players.LocalPlayer.Character["HumanoidRootPart"], info, {
		CFrame = CFgo
	})
	tween:Play()
...
function AnDepZai(Pos)
	...
	pcall(function()
		local tween = game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(Distance / 315, Enum.EasingStyle.Linear), {
			CFrame = Pos
		})
	end)
	tween:Play()
	...
	pcall(function()
		if game:GetService("Players").LocalPlayer and game:GetService("Players").LocalPlayer.Character and game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid") and game:GetService("Players").LocalPlayer.Character:FindFirstChild("HumanoidRootPart") and  game:GetService("Players").LocalPlayer.Character.Humanoid.Health > 0 and game:GetService("Players").LocalPlayer.Character.HumanoidRootPart then
			...
			if IngoreY and (b1.Position - targetCFrameWithDefualtY.Position).Magnitude > 5 then
				...
				local tween = aN:Create(game:GetService("Players").LocalPlayer.Character["HumanoidRootPart"], aO, {
...
spawn(
            function()
	while wait() do
		if FarmMode == "Farm Bone" and _G.AutoFarm and IsThirdSea then
			pcall(  
                            function()
...
spawn(function()
	while wait() do
		if FarmMode == "Farm Katakuri" and _G.AutoFarm and IsThirdSea then
			pcall(function()
...
spawn(function()
	spawn(function()
		while wait(.1) do
			if CacaoBring and _G.BringMonster and IsThirdSea then
				pcall(function()
					for i, v in pairs(game.Workspace.Enemies:GetChildren()) do
...
spawn(function()
	task.spawn(function() 
		while wait() do
			if VayRong and _G.BringMonster and IsThirdSea then 
				pcall(function() 
					for i, v in pairs(game.Workspace.Enemies:GetChildren()) do
...
spawn(function()
	task.spawn(function() 
		while wait() do
			if ConCac and _G.BringMonster and IsThirdSea then 
				pcall(function() 
					for i, v in pairs(game.Workspace.Enemies:GetChildren()) do
...
spawn(function()
	task.spawn(function() 
		while wait() do
			if Ditme and _G.BringMonster and IsSecondSea then 
				pcall(function() 
					for i, v in pairs(game.Workspace.Enemies:GetChildren()) do
...
spawn(
        function()
	while wait() do
		if _G.SelectFarm == "Cacao" and StartFarm and IsThirdSea then
			pcall(  
                    function()
...
spawn(function()
	while wait() do
		if _G.SelectFarm == "Dragon Scale" and StartFarm and IsThirdSea then
			pcall(function()
...
spawn(function()
	while wait() do
		if _G.SelectFarm == "Leather" and StartFarm and IsThirdSea then
			pcall(function()
...
spawn(
	...
	task.spawn(
                    function()
		while wait(.1) do
			if Lon and _G.BringMonster and IsSecondSea then 
				pcall(function() 
					for i, v in pairs(game.Workspace.Enemies:GetChildren()) do
...
spawn(
        function()
	while task.wait() do
		if _G.SelectFarm == "Mystic Droplet" and StartFarm and IsSecondSea then
			pcall(      
                         function()
...
spawn(
        function()
	while task.wait() do
		if _G.SelectFarm == "Vampire Fang" and StartFarm and IsSecondSea then
			pcall(      
                         function()
...
spawn(function()
	while wait() do
		if  _G.Khi_Dot_Len_Dien and IsOldWorld then
			pcall(function()
...
spawn(function()
	while wait() do
		pcall(function()
			if _G.Auto_Nha_Dien and IsSecondSea then
...
spawn(function()
	spawn(function()
		while wait(.1) do
			if RenGuKu and _G.BringMonster and IsSecondSea then
				pcall(function()
					for i, v in pairs(game.Workspace.Enemies:GetChildren()) do
...
spawn(function()
	pcall(function()
		while wait() do
			if _G.Kiem_Lua and IsSecondSea then
...
spawn(function()
	while wait() do
		if Auto_Ki_Di and IsSecondSea then
			pcall(function()
...
spawn(function()
	while wait(.5) do
		pcall(function()
			if _G.Gan_Duoc_Cho_Khi and IsThirdSea then
...
spawn(function()
	while wait(.2) do
		pcall(function()
			if Gan_Haki_Lon and IsThirdSea then
...
spawn(function()
	pcall(function()
		while wait() do
			if _G.ThangDauMatLon and IsThirdSea then
...
spawn(function()
	while wait() do
		if  _G.Long_Ma_Bac_Giang and IsThirdSea then
			pcall(function()
...
spawn(function()
	while wait() do
		if _G.Quest_Nhu_Cai_Lon and IsThirdSea then
			pcall(function()
				if game:GetService("Workspace").Enemies:FindFirstChild("Reborn Skeleton") or game:GetService("Workspace").Enemies:FindFirstChild("Living Zombie") or game:GetService("Workspace").Enemies:FindFirstChild("Demonic Soul") or game:GetService("Workspace").Enemies:FindFirstChild("Posessed Mummy") then
					for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
						if v.Name == "Reborn Skeleton" or v.Name == "Living Zombie" or v.Name == "Demonic Soul" or v.Name == "Posessed Mummy" then
...
spawn(function()
	while wait() do
		if _G.Raidlaw and IsSecondSea then
			pcall(function()
