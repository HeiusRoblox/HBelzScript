--- Skid Tuan Anh Ios:))
--- Kiếm view thoi, skid cho nhanh
print("Break");
local v0 = require(game:GetService("ReplicatedStorage").Notification);
v0.new("<Color=Cyan>Welcome to Mango Hub<Color=/>"):Display();
wait(0.5);
v0.new("<Color=Yellow>I'm Heius Dzz - HieuYeager<Color=/>"):Display();
wait(1);
repeat
	wait();
...
v5.Window = function(v134, v135)
	...
	v170.Image = "http://www.roblox.com/asset/?id="   .. tostring(134823597822060) ;
...
v8.Image = "rbxassetid://134823597822060";
v8.Draggable = true;
...
game:GetService("StarterGui"):SetCore("SendNotification", {
	Title = "Mango Hub",
	Text = "Loading...",
	Icon = "rbxthumb://type=Asset&id=134823597822060&w=150&h=150",
	Duration = 10
});
spawn(function()
	while wait() do
